...
const Vision = () => {
  ...
  return (
    <section className="max-w-7xl mx-auto px-6 sm:px-8 md:px-10 lg:px-16 py-14 md:py-20 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 md:gap-14">
        ...
        {/* ✅ VISION TEXT — below image on mobile, right on desktop */}
        <motion.div
          initial={{ opacity: 0, x: 50 }}
          whileInView={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.6 }}
        ...
        >
          ...
          <p className="mt-3 md:mt-7 text-[14px] sm:text-[15px] md:text-[15px] text-gray-800 leading-tight">
      ...
      >
        ...
        {/* ✅ Left aligned + smaller only on mobile */}
        <h2
          className="text-lg sm:text-xl md:text-[28px] font-medium"
          style={{ color: orange }}
        >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 md:gap-x-10 mt-8">
          {[
